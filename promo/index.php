  ...
  <body>
    ...
    <div class="wrapper">
      <header>
        <div class="container"><a href="https://mastervision.su" target="_blank"><img class="header-logo" src="../img/images/header-logo.png" alt="Логотип"/></a>
          <div class="contacts"><a class="contact contact-tg" href="https://t.me/Master_Vision_Academy" target="_blank"><img src="../img/icons/tg.png" alt="Telegram"/></a><a class="contact contact-email" href="mailto:info@mastervision.su" target="_blank"><img src="../img/icons/envelope.png" alt="Email"/></a></div>
        </div>
      </header>
      <section id="main">
        <div class="container">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="video-wrapper video-wrapper-main">
                  <iframe src="https://www.youtube.com/embed/c33eMwoyroo?autoplay=1&amp;mute=1&amp;modestbranding=1" allowfullscreen></iframe>
                </div>
              </div>
              <div class="col-md-7">
                <div class="content">
                  <p class="main-text"><span>У нас к Вам просьба прямо сейчас подписаться на Телеграм.</span><br>В нем Вы будете получать и напоминания о начале мастер-класса с ссылками на вебинарную комнату</p>
                  <p class="main-text">В благодарность за регистрацию на мастер-класс, в Телеграме Вы получите приятный и полезный бонус - <span>видео-урок "Дизайн человека за 5 минут"</span></p>
    ...
    <footer>
      <div class="container"><a href="https:/mastervision.su/" target="_blank"><img class="footer-logo" src="../img/images/footer-logo.png" alt="Логотип"/></a>
        <div class="row">
          <div class="col-md-6">
            <p class="footer-text">Тюмень, проезд Летний, 9а</p>
            <p class="footer-text"><a href="tel:8-4993467946">8-499-346-79-46</a></p>
            <p class="footer-text"><a href="mailto:info@mastervision.su">info@mastervision.su</a></p>
          </div>
          <div class="col-md-6">
            <p class="footer-text footer-text-right">ИП Кудряшов А. А.</p>
            <p class="footer-text footer-text-right">ИНН 720410077658</p>
          </div>
        </div>
